...
function buildPolicyPrompt(): string {
  return [
    ...
    "Coordination posts must be concrete and actionable: include exact file path, status (blocked/completed), blocker reason, and next step with ETA or unblocking trigger.",
